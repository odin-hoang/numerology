            ...
            >
              ...
              >
                ...
                <motion.blockquote
                  ...
                  viewport={{ once: true }}
                >
                  Con số của tên gọi là <b>số tên hoàn chỉnh</b>, được tính bằng
                  tổng quy đổi mỗi chữ cái trong tên thành số. Chắc chắn bạn đã
                  nhận thấy rằng, cho dù môi trường xung quanh ồn ào đến đâu,
                  khi ai đó gọi tên bạn, sự chú ý của bạn ngay lập tức chuyển
                  hướng sang họ. Tên của chúng ta đã trở thành một âm thanh rất
                  quan trọng đối với chúng ta, cho dù đó là tên thật, biệt danh
                  hay bất kỳ tên gọi nào chúng ta thích sử dụng. Trên thực tế,
                  tên của chúng ta phải được coi là một phần được chấp nhận
                  ...
                  tính cách của chúng ta. <b>Số tên hoàn chỉnh</b> có thể cân
                  bằng hoặc củng cố sức mạnh của Số chủ đạo.
                  <p>
                    <br />
                    {completeNameNumber === rulingNumber ? (
                      ...
                      <span>
                        <b>Số tên hoàn chỉnh</b> và số chủ đạo cùng nằm trên một
                        mặt phẳng thì sự củng cố cân bằng được đưa ra trên mặt
                        phẳng đó{" "}
                      </span>
                    ) : (
                      <span>
                        <b>Số tên hoàn chỉnh</b> nằm trên một mặt phẳng khác với
                        Số chủ đạo, một phạm vi rung động rộng hơn được cung cấp
                ...
                <div>
                  <Table className="w-[210px] h-[210px]">
                    ...
                    <TableCaption className="">
                      ...
                      <span className="text-cyan-600 font-normal">{name}</span>
                    </TableCaption>
                    <TableBody>
                      <TableRow>
                          ...
                          <MeaningOfNumber
                            isolatedContent={
                              isolatedNumbers.includes(3) && (
                                <p>
                                  Khi một hoặc nhiều số 3 xuất hiện mà không có
                                  sự hiện diện của số 2, 5 hoặc 6 trong biểu đồ.
                                  Điều này có nghĩa là tiềm năng tâm trí mạnh mẽ
                                  của họ có thể dễ dàng bị phân tán, vì nó không
                                  kết nối đến Mặt phẳng Vật lý, và sức mạnh của
                                  nó không dễ dàng được đưa vào thực tế. Vấn đề
                                  này có thể trở nên nghiêm trọng hơn khi có
                                  nhiều hơn một số 3 bị cô lập, vì khi đó trí
                                  tưởng tượng có thể trở nên không kiểm soát và
                                  họ có thể bắt đầu tin vào các sự kiện, ý tưởng
                                  hoặc kỳ vọng mà không có sự hỗ trợ từ thực tế
                                  hoặc hiện thực.
                                  <div className="relative py-2 mt-4 px-4  rounded-sm shadow font-nunito bg-tuscany bg-no-repeat bg-cover bg-center text-white/90  ">
                                    ...
                                    <span className="relative z-10">
                                      <b>Cân bằng:</b> bằng cách phát triển các
                                      phẩm chất liên quan đến các số bị thiếu.
                                    </span>
                                    <ul className="space-y-1 relative z-10">
                                      ...
                                      <li>
                                        ...
                                        : phát triển thêm tình yêu và lòng trắc
                                        ẩn trong biểu hiện và học cách tự do bày
                                        tỏ các cảm xúc tích cực của mình thay vì
                                        kìm nén chúng.
                                      </li>
                                      <li>
                                        <span className="underline-offset-2 underline">
                          ...
                          <MeaningOfNumber
                            isolatedContent={
                              isolatedNumbers.includes(9) && (
                                <p>
                                  Khi các số 5, 6 và 8 bị thiếu trong biểu đồ và
                                  người đó có một hoặc nhiều số 9, người đó
                                  ...
                                  trên biểu đồ. Nếu một số 9 duy nhất, nó thường
                                  là dấu hiệu của tham vọng chưa được thực hiện;
                                  nếu có hai số 9, lý tưởng không thực tế; nếu
                                  ba hoặc bốn số 9, cả hai điều trên đều có thể.
                                  <div className="relative py-2 mt-4 px-4  rounded-sm shadow font-nunito bg-tuscany bg-no-repeat bg-cover bg-center text-white/90  ">
                                    <div className="absolute inset-0 rounded-sm bg-yellow-800/40 z-0"></div>
                                    <span className="relative z-10">
                            ...
                            isolatedContent={
                              isolatedNumbers.includes(1) && (
                                <p>
                                  ...
                                  cho người khác, đặc biệt nếu họ có duy nhất
                                  một số 1. Họ gặp khó khăn trong việc giải
                                  thích rõ ràng cho người khác các khái niệm
                                  hoặc hành động họ thực hiện. <br />
                                  Nếu các số còn lại tập trung vào Mặt phẳng tâm
                                  trí (3-6-9), người đó có thể bị coi là lười
                                  biếng hoặc không đáng tin cậy vì rất nhiều
                                  điều đang diễn ra trong đầu họ sẽ không được
                                  chuyển thành biểu hiện thực tế hoặc vì họ cam
                                  kết làm những việc hiếm khi được thực hiện.
                                  Điều này có thể khiến người khác nghĩ rằng
                                  những người có số 1 bị cô lập là không đáng
                                  tin cậy khi thực tế, họ thường không nhận ra
                                  khía cạnh này của bản tính của mình.
                                  <div className="relative py-2 mt-4 px-4  rounded-sm shadow font-nunito bg-tuscany bg-no-repeat bg-cover bg-center text-white/90  ">
                            ...
                            isolatedContent={
                              isolatedNumbers.includes(7) && (
                                <p>
                                  ...
                                  phải của Biểu đồ mà không có các số 4, 5 hoặc
                                  8 xung quanh, những hy sinh và bài học mà
                                  người đó phải học thường phải lặp lại. <br />
                                  ...
                                  Những người này có thể trải qua mất mát trong
                                  sức khoẻ, tình yêu hoặc tài sản tiền bạc lặp
                                  đi lặp lại cho đến khi người đó học được bài
                                  học cần thiết từ các trải nghiệm của mình và
                                  áp dụng chúng vào cuộc sống của mình. Mặc dù
                                  điều này thường gây đau đớn cho người hy sinh,
                                  họ thường chấp nhận nó như định mệnh hoặc sự
                                  không thể tránh khỏi. Sự đau đớn thường dường
                                  như nặng hơn đối với bạn bè và người thân của
                                  người phải hy sinh. <br />
                                  ...
                                  hơn về những thách thức và bài học mà họ phải
                                  đối mặt trong cuộc sống. Họ có thể có khả năng
                                  phân tích và suy ngẫm sâu hơn về những trải
                                  nghiệm của mình, giúp họ đối mặt với những
                                  thách thức một cách nhẹ nhàng và thông thái
                                  hơn.
                                  <div className="relative py-2 mt-4 px-4  rounded-sm shadow font-nunito bg-tuscany bg-no-repeat bg-cover bg-center text-white/90  ">
                                    <div className="absolute inset-0 bg-yellow-800/40 z-0 rounded-sm "></div>
                                    ...
                                    <ul className="space-y-1 relative z-10">
                                      <li>
                                        ...
                                        yêu cầu sự giúp đỡ hoặc hướng dẫn. Đồng
                                        thời, điều này phát triển Mũi Tên Thực
                                        Tiễn (1-4-7) để người đó phát triển một
                                        cách tiếp cận thực tế đối với các trải
                                      ...
                                      <li>
                                        ...
                                        : học cách áp dụng trực giác thực tế
                                        thông qua hành động yêu thương. Điều này
                                        cũng giúp phát triển cảm giác độc lập
                                        của họ, và cuối cùng là xây dựng Mũi Tên
                                        Hoạt Động (7-8-9)
                                      </li>
                                    </ul>
                                  </div>
